...
export class ProductDetailsComponent implements OnInit {
  ...
  constructor(public modalController: ModalController,
    public storageService: StorageService, public alertController: AlertController, public location:Location,public productsService: ProductsService, private translateConfigService: TranslateConfigService, public http: HttpClient, public loadingCtrl: LoadingController, private platform: Platform,private translate:TranslateService) {
